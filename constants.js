...
// number that determins  when a player has accomplish the max score
export const winningNumber = 10;

// **** Weights **** //
export const startingWeight = 4;
export const maxWeight = 15;
export const minWeight = 1;
export const weightDiff = 2;
// **** End Weights **** //
