...
export const itemsDto = {
  ...
  FH: new ItemDto('Frozen Heart', 'Adjacent enemies lose 25% Attack Speed for 1 second.', new Recipe(basicItems.Vest, basicItems.Tear), fh),
  locket: new ItemDto('Locket of the Iron Solari', 'On start of combat, allies two spaces to the left and right gain a shield of 300 for 8 seconds.', new Recipe(basicItems.Vest, basicItems.Rod), locket),
  thornmail: new ItemDto('Bramble Vest', 'Negates bonus damage from incoming critical hits. On being hit by a Basic Attack, deal 80/120/160 magic damage to all nearby enemies (once every 1 second maximum). Scales with wearer’s Star Level.', new Recipe(basicItems.Vest, basicItems.Vest), bv),
  ...
  ionic: new ItemDto('Ionic Spark', 'Whenever an enemy casts a spell, they take 90 true damage.', new Recipe(basicItems.Rod, basicItems.Cloak), ionic),
  luden: new ItemDto('Luden\'s Echo', 'Deal 150 splash damage on ability hit.', new Recipe(basicItems.Rod, basicItems.Tear), luden),
  ...
  statikk: new ItemDto('Stattik Shiv', 'Every 3rd attack deals 100 splash magical damage to 3 enemies.', new Recipe(basicItems.Recurve, basicItems.Tear), statikk),
  ...
  ig: new ItemDto('Iceborn Gauntlet', 'On dodge, create a spreading 25% Attack Speed slow zone.', new Recipe(basicItems.Gloves, basicItems.Vest), ig),
